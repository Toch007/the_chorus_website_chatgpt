...
const partnershipTypes = [
  {
    ...
    description:
      "Amplify our voice through media, social platforms, and networks.",
  },
  {
    icon: <Building2 className="w-8 h-8 text-blue-700" />,
    title: "Corporate Sponsorship",
    description:
      "Fund initiatives or provide financial backing for special projects.",
  },
  {
    icon: <Wrench className="w-8 h-8 text-blue-700" />,
    title: "Technical & Logistics",
    description:
      "Provide equipment, transportation, or tech support for events.",
  },
  {
    icon: <Handshake className="w-8 h-8 text-blue-700" />,
    title: "Community Outreach",
    description:
      "Collaborate with us for grassroots events and impact projects.",
  },
];
...
export default function PartnersPage() {
  return (
    <>
      <Header />
      <main className="max-w-4xl mx-auto px-4 pt-24 pb-20 space-y-16 text-center">
        <Reveal>
        ...
        <Reveal>
          <p className="text-gray-700 max-w-2xl mx-auto">
            We welcome partnerships for media, outreach, logistics, events, and
            more. Let’s create something beautiful together.
          </p>
        </Reveal>
        ...
        <Reveal>
          <div className="mt-16 max-w-2xl mx-auto">
            ...
            <p className="text-gray-700 mb-6">
              Whether you're a brand, organization, or individual, your support
              can help us create powerful musical experiences and impact lives.
            </p>
