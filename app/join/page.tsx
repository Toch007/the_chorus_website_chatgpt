      ...
      <main className="space-y-20">
        ...
        <section className="relative pt-24 pb-20 px-4 overflow-hidden">
          ...
          <div
            ...
            style={{
              backgroundImage: "url('/images/groupp_2.jpg')",
            }}
          >
          ...
          <div className="relative max-w-6xl mx-auto text-center z-10">
            <Reveal>
              <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-md border border-white/40 px-4 py-2 rounded-full mb-6 shadow-lg">
              ...
              <p className="text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed mb-12 drop-shadow-md">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                {statistics.map((stat, index) => (
                  <Reveal key={index} delay={index * 0.1}>
                    <div className="bg-white/15 backdrop-blur-md border border-white/40 rounded-2xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group hover:bg-white/25 hover:scale-105">
                      <div className="w-12 h-12 bg-yellow-300/30 backdrop-blur-sm rounded-xl flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform border border-yellow-300/50">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
                <Link
                  href="/join/choir"
                  className="bg-white/15 backdrop-blur-md border border-white/40 text-white px-6 py-4 rounded-xl hover:bg-white/30 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl hover:-translate-y-1 flex items-center justify-center gap-2 group"
                >
              ...
              <div className="mt-8 text-center">
                <p className="text-sm text-blue-200 drop-shadow-md">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* Why Join Us Section */}
          <section className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-3xl p-12 mt-20">
            <Reveal>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                  Discover the unique benefits and opportunities that await you
                  as a member of our musical family
                </p>
              </div>
            </Reveal>
              ...
              <Reveal delay={0.4}>
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-blue-100">
                  ...
                  <p className="text-gray-600">
                    ...
                    designed to accommodate different lifestyles and
                    commitments.
                  </p>
                </div>
              </Reveal>
            ...
            <section>
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-6">
                  ...
                  spreading joy through music. Each option has a dedicated
                  application form.
                </p>
              ...
              <Reveal delay={0.4}>
                <div className="bg-white/80 backdrop-blur-sm border border-blue-100 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 group">
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      <p className="text-gray-700 leading-relaxed mb-4 italic">
                        "I love the energy, the passion, and the sense of
                        purpose here. It's powerful how music can unite people
                        and touch hearts. This community has changed my life."
                      </p>
                      <div className="flex items-center gap-3">
              ...
              <Reveal delay={0.6}>
                <div className="bg-white/60 backdrop-blur-sm border border-purple-100 p-6 rounded-2xl hover:bg-white/80 transition-all duration-300">
                  ...
                  <p className="text-gray-700 text-sm italic mb-3">
                    "The vocal training here is exceptional. I've discovered
                    parts of my voice I never knew existed."
                  </p>
