...
export default function JoinChoirPage() {
  ...
  const validate = () => {
    ...
    if (!formData.dob) newErrors.dob = "Date of birth is required";
      ...
      const age = currentYear - new Date(formData.dob).getFullYear();
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-6 pt-24 pb-20">
        ...
        <p className="mb-6 text-gray-700">
          Fill out the form below to join The Chorus Abuja Choir. Please answer
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            {errors.voicePart && (
              <p className="text-red-500">{errors.voicePart}</p>
            )}
          </div>
