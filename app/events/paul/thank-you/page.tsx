...
import { Heart, Music, Users, Calendar, Share2 } from "lucide-react";
import { useState } from "react";

export default function PaulThankYouPage() {
  ...
  const handleShare = (platform: string) => {
    const text =
      "I just experienced Mendelssohn's Paul with The Chorus Abuja - what an incredible 5th Anniversary performance! 🎭✨";
    const url = "https://thechorusabuja.org/events/paul";
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 text-center text-white">
        ...
        >
          ...
          >
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-br from-amber-400 to-amber-600 rounded-full p-6">
          ...
          <motion.h1
            ...
            className="text-4xl md:text-6xl font-extrabold mb-4 bg-gradient-to-r from-amber-300 via-yellow-100 to-amber-300 bg-clip-text text-transparent"
          >
            Thank You for 5 Unforgettable Years! 🎭
          </motion.h1>
          ...
          >
            ...
            made our 5th Anniversary Grand Concert truly magical. Together, we
            celebrated five years of choral excellence in Abuja.
          </motion.p>
        ...
        >
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-purple-400/30 rounded-xl p-6">
            ...
            <p className="text-gray-300">Of choral excellence in Abuja</p>
          </div>
        ...
        <motion.div
          ...
          className="max-w-2xl w-full bg-gradient-to-br from-amber-400/10 to-orange-400/10 backdrop-blur-sm border border-amber-400/30 rounded-2xl p-8 mb-8"
        >
          ...
          {!subscribed ? (
            ...
            >
              <input
                ...
                required
                className="flex-1 px-4 py-3 rounded-full bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-amber-400"
              />
              <button
                type="submit"
                className="bg-gradient-to-r from-amber-400 to-amber-600 hover:from-amber-500 hover:to-amber-700 text-blue-900 px-8 py-3 rounded-full font-bold transition-all hover:scale-105 shadow-lg"
              >
                Subscribe
              </button>
            </form>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 text-left">
              ...
              <p className="text-gray-300 mb-4">
                Our next performance is being planned. Check our events page for
                dates, venues, and ticket details as they're announced.
              </p>
              <Link
                href="/events"
                className="inline-block bg-amber-400 hover:bg-amber-300 text-blue-900 px-6 py-2 rounded-full font-semibold transition-all"
              >
                View Events
              </Link>
            </div>
        ...
        >
          <p className="text-xl text-gray-200 mb-6">
            ...
            , thank you for making our 5th Anniversary Grand Concert a night to
            remember. We look forward to sharing more musical magic with you
            soon!
          </p>
